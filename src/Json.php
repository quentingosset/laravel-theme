...
use Nwidart\Themes\Exceptions\InvalidJsonException;
...
class Json
{
    ...
    public function getAttributes()
    {
        ...
        if (config('themes.cache.enabled') === false) {
            return $attributes;
        }

        return app('cache')->remember($this->getPath(), config('themes.cache.lifetime'), function () use ($attributes) {
            return $attributes;
        });
    }

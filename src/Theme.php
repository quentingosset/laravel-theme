...
abstract class Theme
{
    ...
    /**
     * Register the aliases from this theme.
     */
    abstract public function registerAliases(): void;

    /**
     * Register the service providers from this theme.
     */
    abstract public function registerProviders(): void;

    /**
     * Get the path to the cached *_theme.php file.
     *
     * @return string
     */
    ...
    /**
     * Register the files from this theme.
     */
     ...
     */
    public function setThemeDefault(): void
    {
        $this->activator->setThemeDefault($this);
    }
    ...
    {
        return $this->activator->getThemeDefault();
    }
    ...
    {
        return config('themes.register.files', 'register') === 'boot' &&
            // force register method if option == boot && app is AsgardCms
            !class_exists('\Themes\Core\Foundation\AsgardCms');
    }

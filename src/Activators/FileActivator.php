...
namespace Nwidart\Themes\Activators;

use Illuminate\Cache\CacheManager;
use Illuminate\Config\Repository as Config;
use Illuminate\Support\Facades\Config as ConfigWriting;
...
class FileActivator implements ActivatorInterface
{
    ...
    {
        ConfigWriting::write('themes.default', Str::lower($name));
    }
    ...
    {
        return $this->config->get('themes.default');
    }
     ...
     * @return mixed
     */
    private function writeConfig(string $key, $default = null)
    {
        return $this->config->set($key, $default);
    }
    /**
